...
struct Test {
	...
	#[validate(allowlist("SINGLE", ["a", "b"], "custom message 2", "custom_code_2"))]
	pub a: String,
	#[validate(allowlist("SINGLE", ["a", "b"], "custom message", "custom_code"))]
	#[validate(allowlist("SINGLE", ["a", "b"], "custom message 2", "custom_code_2"))]
	pub b: Option<String>,
	#[validate(allowlist("COLLECTION", ["a", "b"], "custom message", "custom_code"))]
	#[validate(allowlist("COLLECTION", ["a", "b"], "custom message 2", "custom_code_2"))]
	pub c: Vec<String>,
	#[validate(allowlist("COLLECTION", ["a", "b"], "custom message", "custom_code"))]
	#[validate(allowlist("COLLECTION", ["a", "b"], "custom message 2", "custom_code_2"))]
